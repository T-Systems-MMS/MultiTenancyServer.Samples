    ...
    public class SeedData
    {
        public static void EnsureSeedData(IServiceProvider serviceProvider)
        {
            ...
            using (var scope = serviceProvider.GetRequiredService<IServiceScopeFactory>().CreateScope())
            {
                ...
                var tenantMgr = scope.ServiceProvider.GetRequiredService<TenantManager<ApplicationTenant, long>>();
            ...
            using (var scope = serviceProvider.GetRequiredService<IServiceScopeFactory>().CreateScope())
            {
                ...
                var tenancyContext = scope.ServiceProvider.GetService<ITenancyContext<ApplicationTenant, long>>();
